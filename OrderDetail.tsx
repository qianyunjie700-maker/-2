            ...
            <div className="tech-card tech-border p-6 relative overflow-hidden">
                ...
                <div className="space-y-6 font-mono">
                    <div>
                        ...
                        <p className="text-xl text-cyan-400 font-bold tracking-wider drop-shadow-[0_0_5px_rgba(34,211,238,0.5)]">{order.details?.tracking_number || order.tracking_number || order.order_number}</p>
                    </div>
                    <div>
